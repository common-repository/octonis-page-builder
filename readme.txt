...
Octonis will completely change your opinion on website development to the better!
...
= 1.0.6 / 18.03.2016 =
 * Added google fonts
 * Added options for the page
 * Added a list of posts when editing links
 * Added extension for elements change
 * Fixed errors in the blocks and in the editor

= 1.0.5 / 08.02.2016 =
 * Added ability to select the preset
 * Added contact form block
 * Added Google Map block
 * Added presets: "Agency", "Application Startup", "Cyrcling"
 * Added textarea field type in the contact form

= 1.0.4 / 04.01.2016 =
 * Added a new color picker
 * Ability to add links to icons and pictures
 * Added the ability to make the font 10,9,8 point
 * Fixed hiding of submenu
 * Added border for color picker
 ...
 * Move blocks panel back to left side
 * Added Button element
 * Fix separators to make them as images
 * Added Icons element
 * Admin area - Posts page metabox design improvements
 * Added Grid element
 * Minor issues fix
