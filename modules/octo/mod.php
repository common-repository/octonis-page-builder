...
class octoOct extends moduleOct {
	...
	private $_oldAssetsUrl = 'https://supsystic.com/_assets/octo/';
	...
	public function addMetaBoxes() {
		...
		add_meta_box('octTemplateMetaBox', OCT_WP_PLUGIN_NAME, array($this, 'showTemplateMetaBox'), null, 'normal', 'high');
	}
	public function showTemplateMetaBox($post) {
		$this->getView()->showTemplateMetaBox($post);
	}
	...
	public function getAssetsUrl() {
		if(empty($this->_assetsUrl)) {
			if(uriOct::isHttps()) {
				$this->_assetsUrl = 'https://supsystic.com/_assets/octo/';
			} else {
				$this->_assetsUrl = 'http://cdn.supsystic.com/_assets/octo/';
			}
		}
