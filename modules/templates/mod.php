...
class templatesOct extends moduleOct {
	...
	public function loadCustomBootstrapColorpicker() {
		...
		if(!$loaded) {
			...
			frameOct::_()->addScript('oct.colors.script', OCT_JS_PATH. 'colorPicker/color.all.min.js');
			frameOct::_()->addStyle('oct.colors.style', OCT_JS_PATH. 'colorPicker/color.css');
